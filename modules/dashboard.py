...
def render_dashboard() -> None:
    ...
    if not flujo_proyectado.empty:
        ...
        f7 = flujo_proyectado[flujo_proyectado["horizonte_dias"] == 7]
        f15 = flujo_proyectado[flujo_proyectado["horizonte_dias"] == 15]
        f30 = flujo_proyectado[flujo_proyectado["horizonte_dias"] == 30]
        ...
        elif not flujo_proyectado.empty:
    ...
    estado_salud, detalle_salud = _health_status(ventas_total, utilidad, stock_bajo, flujo_30d)
