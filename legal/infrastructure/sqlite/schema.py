...
def migrate_enterprise_legal() -> None:
    """Create only the enterprise legal foundation schema.

    Operational domains such as contracts, litigation, compliance and governance
    live in versioned migrations under ``legal/migrations``. Keeping this base
    migration small prevents incompatible ``CREATE TABLE IF NOT EXISTS`` shapes.
    """
